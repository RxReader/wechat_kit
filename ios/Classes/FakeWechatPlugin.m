...
@implementation FakeWechatPlugin {
...
+ (void)registerWithRegistrar:(NSObject<FlutterPluginRegistrar>*)registrar {
    FlutterMethodChannel* channel = [FlutterMethodChannel
                                     methodChannelWithName:@"v7lin.github.io/fake_wechat"
                                     binaryMessenger:[registrar messenger]];
    FakeWechatPlugin* instance = [[FakeWechatPlugin alloc] initWithChannel:channel];
...
static NSString * const ARGUMENT_KEY_MUSICLOWBANDDATAURL = @"musicLowBandDataUrl";
...
-(void) handleQRAuthCall:(FlutterMethodCall*)call result:(FlutterResult)result {
    if ([METHOD_STARTQRAUTH isEqualToString:call.method]) {
        ...
        [_qrauth Auth:appId nonceStr:noncestr timeStamp:timestamp scope:scope signature:signature schemeData:nil];
...
-(void) handleShareMediaCall:(FlutterMethodCall*)call result:(FlutterResult)result {
    ...
    if ([METHOD_SHAREIMAGE isEqualToString:call.method]) {
        ...
        mediaObject.musicLowBandDataUrl = call.arguments[ARGUMENT_KEY_MUSICLOWBANDDATAURL];
        message.mediaObject = mediaObject;
        ...
        FlutterStandardTypedData * hdImageData = call.arguments[ARGUMENT_KEY_HDIMAGEDATA];
        if (hdImageData != nil) {
...
-(void) handleSubscribeMsgCall:(FlutterMethodCall*)call result:(FlutterResult)result {
...
-(void) handleLaunchMiniProgramCall:(FlutterMethodCall*)call result:(FlutterResult)result {
