 ...
 * WechatKitPlugin
 */
public class WechatKitPlugin implements MethodCallHandler, PluginRegistry.ViewDestroyListener {
    /**
     * Plugin registration.
     */
    public static void registerWith(Registrar registrar) {
        final MethodChannel channel = new MethodChannel(registrar.messenger(), "v7lin.github.io/wechat_kit");
        WechatKitPlugin plugin = new WechatKitPlugin(registrar, channel);
    ...
    private WechatKitPlugin(Registrar registrar, MethodChannel channel) {
